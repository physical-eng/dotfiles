...
./configure \
    ...
    --enable-perlinterp \
    --enable-pythoninterp \
     --with-python-config-dir=/home/ito.nobuo/.pyenv/versions/${PY2_VER}/lib/python2.7/config \
    --enable-python3interp \
     --with-python3-config-dir=/home/ito.nobuo/.pyenv/versions/${PY3_VER}/lib/python3.6/config-3.6m-x86_64-linux-gnu \
    --enable-rubyinterp \
    --enable-luainterp \
